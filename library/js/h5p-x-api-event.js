...
H5P.XAPIEvent.prototype.setObject = function (instance) {
    console.log('setObject ENTER');
    console.log(instance);
  if (instance.contentId) {
    this.data.statement.object = {
      'questionusageid': this.getContentXAPIId(instance),
      'objectType': 'Activity',
      'definition': {
        'extensions': {
      ...
      'moreinfo': {
        'cmid': this.getContentcmID(instance),
...
H5P.XAPIEvent.prototype.getContentXAPIId = function (instance) {
  ...
  if (instance.contentId && H5PIntegration && H5PIntegration.contents && H5PIntegration.contents['cid-' + instance.contentId]) {
    xAPIId =  H5PIntegration.contents['cid-' + instance.contentId].questionusageid;
  }
  return xAPIId;
};
...
*   The H5P instance
*/
H5P.XAPIEvent.prototype.getContentcmID = function (instance) {
  return  H5PIntegration.contents['cid-' + instance.contentId].cmid;
};
/**
