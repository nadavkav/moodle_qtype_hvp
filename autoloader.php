 ...
 */
function qtype_hvp_autoloader($class) {
    global $CFG;
    static $classmap;
    if (!isset($classmap)) {
        $classmap = array(
        // Core.
        'qtype_hvp_library\H5PCore' => 'library/h5p.classes.php',
        'qtype_hvp_library\H5PFrameworkInterface' => 'library/h5p.classes.php',
        'qtype_hvp_library\H5PContentValidator' => 'library/h5p.classes.php',
        'qtype_hvp_library\H5PValidator' => 'library/h5p.classes.php',
        'qtype_hvp_library\H5PStorage' => 'library/h5p.classes.php',
        'qtype_hvp_library\H5PExport' => 'library/h5p.classes.php',
        'qtype_hvp_library\H5PDevelopment' => 'library/h5p-development.class.php',
        'qtype_hvp_library\H5PFileStorage' => 'library/h5p-file-storage.interface.php',
        'qtype_hvp_library\H5PDefaultStorage' => 'library/h5p-default-storage.class.php',
        'H5PEventBase' => 'library/h5p-event-base.class.php',
        'H5PMetadata' => 'library/h5p-metadata.class.php',

        // Editor.
        'qtype_hvp\editor\H5peditor' => 'editor/h5peditor.class.php',
        'qtype_hvp\editor\H5peditorAjax' => 'editor/h5peditor-ajax.class.php',
        'qtype_hvp\editor\H5PEditorEndpoints' => 'editor/h5peditor-ajax.class.php',
        'qtype_hvp\editor\H5peditorAjaxInterface' => 'editor/h5peditor-ajax.interface.php',
        'qtype_hvp\editor\H5peditorFile' => 'editor/h5peditor-file.class.php',
        'qtype_hvp\editor\H5peditorStorage' => 'editor/h5peditor-storage.interface.php',
    ...
    if (isset($classmap[$class])) {
        require_once($CFG->dirroot . '/question/type/hvp/' . $classmap[$class]);
    }
}
spl_autoload_register('qtype_hvp_autoloader');
