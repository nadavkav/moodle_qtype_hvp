...
class upload_libraries_form extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('checkbox',
            'onlyupdate',
            get_string('options', 'qtype_hvp'),
            get_string('onlyupdate', 'qtype_hvp'),
            array('group' => 1)
        );
        ...
        $mform->addElement('checkbox',
            ...
            '',
            get_string('disablefileextensioncheck', 'qtype_hvp'),
            array('group' => 1)
        );
        ...
        $notification = $OUTPUT->notification(
            get_string('disablefileextensioncheckwarning', 'qtype_hvp'),
            'notifymessage'
        );
        $mform->addElement('static', '', '', $notification);

        // Upload button.
        $this->add_action_buttons(false, get_string('upload', 'qtype_hvp'));
    }
