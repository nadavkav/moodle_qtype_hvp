...
use qtype_hvp\editor\H5peditorStorage;
...
class editor_framework implements H5peditorStorage {
    ...
    public function getLanguage($name, $major, $minor, $lang) {
        ...
        return $DB->get_field_sql(
            "SELECT hlt.language_json
               FROM {qtype_hvp_libs_languages} hlt
               JOIN {qtype_hvp_libraries} hl ON hl.id = hlt.library_id
    ...
    public function keepFile($fileid) {
        ...
        $DB->delete_records('qtype_hvp_tmpfiles', array(
            'id' => $fileid
        ));
    }
    ...
    public function getLibraries($libraries = null) {
        ...
        $superuser = has_capability('qtype/hvp:userestrictedlibraries',
    ...
    public static function markFileForCleanup($file, $contentid = null) {
        ...
        $DB->insert_record_raw('qtype_hvp_tmpfiles', array(
            'id' => $file
        ), false, false, true);
    }
