...
use \qtype_hvp_library\H5PDevelopment as H5PDevelopment;
use \stdClass as stdClass;

require_once($CFG->dirroot . '/question/type/hvp/editor/h5peditor-ajax.class.php');
...
class H5peditor {
  ...
  function __construct($h5p, $storage, $ajaxInterface) {
    ...
    $this->ajax = new \qtype_hvp\editor\H5peditorAjax($h5p, $this, $storage);
  }
  ...
  public function canInstallContentType($contentType) {
    $canInstallAll         = $this->h5p->h5pF->hasPermission(\qtype_hvp_library\H5PPermission::UPDATE_LIBRARIES);
    $canInstallRecommended = $this->h5p->h5pF->hasPermission(\qtype_hvp_library\H5PPermission::INSTALL_RECOMMENDED);
