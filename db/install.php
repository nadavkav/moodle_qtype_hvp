...
function xmldb_qtype_hvp_install() {
    ...
    // Print any messages.
    echo '<h3>' . get_string('welcomeheader', 'qtype_hvp') . '</h3>' .
         '<p>' .
         get_string('welcomegettingstarted', 'qtype_hvp', array(
         ...
         '</p>' .
         '<p>' .
         get_string('welcomecommunity', 'qtype_hvp', array(
             'forums' => 'href="https://h5p.org/forum" target="_blank"'
         )) .
         '</p>' .
         '<p>' . get_string('welcomecontactus', 'qtype_hvp',
